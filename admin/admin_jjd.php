...
global $xoopsModule, $xoopsDB;
    ...
    $link = BuildLink ('lex_lexique', 'idLexique', 'name',
                       "admin_lexique.php?op=edit&idLexique=%0%", 'name');   
    echo "<p>-&nbsp;<A HREF='admin_lexique.php?op=list'>"._AD_LEX_LEXIQUE_MANAGEMENT."</A> : {$link}<br>";
    
    $link = BuildLink ('lex_selecteur', 'idSelecteur', 'name',
                       "admin_selecteur.php?op=edit&idSelecteur=%0%", 'name');   
    echo "<p>-&nbsp;<A HREF='admin_selecteur.php?op=list'>"._AD_LEX_SELECTEUR_MANAGEMENT."</A> : {$link}<br>";
    
    $link = BuildLink ('lex_family', 'idFamily', 'name',
                       "admin_family.php?op=edit&id=%0%", 'name');   
    echo "<p>-&nbsp;<A HREF='admin_family.php?'>"._AD_LEX_CATEGORY_MANAGEMENT."</A> : {$link}</p>";
    
    $link = BuildLink ('lex_caption', 'idCaption', 'name',
                       "admin_caption.php?op=edit&idCaption=%0%", 'name');   
    echo "<p>-&nbsp;<A HREF='admin_caption.php?'>"._AD_LEX_CAPTION_MANAGEMENT."</A> : {$link}</p>";
    
    $link = BuildLink ('lex_property', 'idProperty', 'name',
                       "admin_property.php?op=edit&idProperty=%0%", 'name');   
    echo "<p>-&nbsp;<A HREF='admin_property.php?'>"._AD_LEX_PROPERTY_MANAGEMENT."</A> : {$link}</p>";
    */    
    //**********************************************************************************
    CloseTable();
...
global $xoopsModule, $xoopsDB;
    ...
    //**********************************************************************************
    $link = BuildLink ('lex_lexique', 'idLexique', 'name',
                       XOOPS_URL."/modules/lexique/index.php?idLexique=%0%", 'name');   
    echo "<p>-&nbsp;<A HREF='..'>"._AD_LEX_NAME."</A> : {$link}</p>";
    
    
    echo "<p>- "._AD_LEX_DOCUMENTATIONS." : ".BuildLinkOnFolderDoc()."</p>";                  
    //JJD-Import a revoir
...
global $xoopsModule, $xoopsDB;
    ...
    echo "<p>-&nbsp;<A HREF='lex_action.php?op=killTemp'>"._AD_LEX_ZAPTEMP."</A></p>";
    echo "<p>-&nbsp;<A HREF='lex_action.php?op=clearTempLink'>"._AD_LEX_SA_VIDAGEDUCACHE."</A></p>";
    
    echo "<p>-&nbsp;<A HREF='lex_update_seealso.php?op=valider' target='blanck'>"._AD_LEX_UPDATE_SEEALSO."</A><br>";
    echo "&nbsp;"._AD_LEX_UPDATE_SEEALSO_DSC2."</p>";
      ...
      if($submit == 0) {
        ...
        $lib = constant($lib2);
      	...
      	while ( list($idTerme, $name,$shortDef, $lexique, $idLexique) = $xoopsDB->fetchRow($submitdef) ) {
         	...
         	$linkDel = "del-def.php?op=delete&id={$idTerme}&idLexique={$idLexique}";
...
*****************************************************************************/
$bOk = true;
if ($bOk){admin_xoops_cp_header(_LEX_ONGLET_JJD_TOOLS, $xoopsModule);}   
