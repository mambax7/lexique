...
*****************************************************************************/
   ...
   admin_xoops_cp_header(_LEX_ONGLET_DOC + $gepeto['numDoc'], $xoopsModule);
   $tDoc = array('help/lexique','licence/GPL'); 
...
//    viewDoc ($tDoc[$gepeto['numDoc']], $xoopsConfig['language'], _LEX_ROOT_PATH);
    ...
    viewDocFromSite ('lexique', $tDoc[$gepeto['numDoc']], $xoopsConfig['language'], $root);  
